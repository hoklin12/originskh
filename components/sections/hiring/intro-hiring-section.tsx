...
const IntroHiringSection = React.forwardRef<HTMLElement>((props, ref) => {
  const images = [
    { src: '/placeholder3.jpg', className: 'h-80 w-80' },
    { src: '/placeholder2.png', className: 'h-60 w-80' },
    { src: '/placeholder2.png', className: 'h-60 w-80' },
    { src: '/placeholder3.jpg', className: 'h-80 w-80' },
    { src: '/placeholder2.png', className: 'h-60 w-80' },
  ];
  ...
  return (
    <section ref={ref} id="intro" className="min-h-screen bg-white m-0 p-0 pt-32">
      ...
      <div className="text-center mb-4 px-12 pb-24">
          <div className="flex items-center justify-center">
            <p className="text-3xl font-light text-black mr-4" style={{ fontFamily: 'Inter, sans-serif' }}>
        ...
        <VideoSection
          ...
          id="intro"
          showControls={true}       // Make sure custom controls are visible
            ...
            <div className="bg-white py-16 px-12">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <p>
                      ...
                      <br /><br />
                      All of these practices are rooted in our values, and are central 
                      to what makes Instrument so unique among the rest. At Instrument, we take your career development 
                      seriously. We promote a culture of mentorship in every discipline, and strive to see each employee 
                      reach their full potential, and do the best work of their career.
                    </p>
...
export default IntroHiringSection;