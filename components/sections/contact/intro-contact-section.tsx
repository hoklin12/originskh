...
export default IntroContactSection;
    ...
    //         3529 N Williams Ave., Portland, OR 97227
    //       </p>
    //       <p className="text-base text-gray-800 mb-4">(503) 928-3188</p>
    //       <a
    //         href="#"
    //         className="text-sm font-bold text-black hover:text-orange-600 transition-colors"
    //       >
    ...
    //       <h3 className="text-2xl font-bold mb-4">
    //         New York, NY{' '}
    //         <span className="ml-4 text-lg font-normal">03:32 AM</span>
    //       </h3>
    //       <p className="text-base text-gray-800 mb-4">
    //         One World Trade Center, 87 Vesey St., Floor 69, New York, NY 10007
    //       </p>
    //       <a
    //         href="#"
    //         className="text-sm font-bold text-black hover:text-orange-600 transition-colors"
