...
export default function OurStudiosSection() {
  const slides = [
    {
      title: "Creatives",
      description: "Started creative exploration in Singapore. Collaborative Projects in Bacolod, Perth, Johor Bahru & Kuala Lumpur.",
      image: "/creative.png",
    },
    {
      title: "Productions",
      ...
      <div className="container relative z-10 px-4 mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
          ...
          <div className="w-full md:w-1/2 text-left">
            <h3 className="text-2xl md:text-3xl font-bold text-black mb-4">We're A Creative Powerhouse.</h3>
            <p className="text-gray-600 mb-6 text-sm md:text-base">
              As a dynamic and multi-disciplinary Creative Powerhouse,
              ORIGINS STUDIOS operates across three distinct sectors:
              ORIGINS Creative, ORIGINS Production & ORIGINS Concept.
              Each sector designed to bring visionary projects to life
              through bold ideas and innovative execution.
            </p>
            <button className="flex items-center px-6 py-3 bg-black text-white rounded-full font-bold hover:bg-orange-600 transition-colors text-sm md:text-base">
              See more <ArrowRight size={18} className="ml-2" />
            </button>
          </div>
