...
export default function OurWorkSection() {
  ...
  const imageMap: { [key: string]: { src: string; caption: string; hashtags: string; description: string }[] } = {
    ...
    MARKETING: [
      { src: '/staria.JPEG.png', caption: 'Mercury', hashtags: '#MARKETING', description: 'Description for Mercury' },
      { src: '/staria.JPEGpng', caption: 'Microsoft', hashtags: '#MARKETING', description: 'Description for Microsoft' },
      { src: '/staria.JPEG.png', caption: 'Google Shopping', hashtags: '#MARKETING', description: 'Description for Google Shopping' },
    ],
    PRODUCT: [
      { src: '/staria.JPEG.png', caption: 'Placeholder 1', hashtags: '#PRODUCT', description: 'Description for Placeholder 1' },
      { src: '/staria.JPEG.png', caption: 'Placeholder 2', hashtags: '#PRODUCT', description: 'Description for Placeholder 2' },
      { src: '/staria.JPEG.png', caption: 'Placeholder 3', hashtags: '#PRODUCT', description: 'Description for Placeholder 3' },
    ],
  };
  ...
  const currentImages = imageMap[activeCategory] || [
    { src: '/timeline-3.png', caption: 'No caption', hashtags: '', description: 'No description' },
  ];
