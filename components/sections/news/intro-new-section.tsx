...
const IntroNewsSection = React.forwardRef<HTMLElement>((props, ref) => {
  const articles = [
    ...
    {
      id: 5,
      title: 'AI-Powered Innovations for 2025', // Unique title
      description:
        'lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
      image: '/placeholder3.jpg',
      time: '7 minutes',
    ...
    {
      id: 6,
      title: 'Connecting Communities in 2025', // Unique title
      description:
        'lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
      image: '/placeholder3.jpg',
      time: '5 minutes',
    ...
    {
      id: 7,
      title: 'Scaling Agencies with Impact', // Unique title
      description:
        'lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
      image: '/placeholder3.jpg',
      time: '5 minutes',
    ...
    {
      id: 8,
      title: '2025 Transparency Report', // Unique title
      description:
        'lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
      image: '/placeholder3.jpg',
      time: '5 minutes',
