...
const OurOValuesSection = React.forwardRef<HTMLElement>((props, ref) => {
  ...
  const valuesData: ValueData[] = [
    {
      id: '1',
      title: 'O’riginality.',
      description: 'We lead with boldness and bring fresh, inventive energy into everything we create.',
    ...
    },
    {
      id: '2',
      title: 'O’thenticity.',
      description: 'We keep it real with our creation reflecting depth and emotional resonance.',
      image: '/placeholder.png',
    ...
    },
    {
      id: '3',
      title: 'O’wesomeness.',
      description: 'Our standard is excellence. We aim to “wow” through wonder, quality and impact.',
      image: '/placeholder.png',
